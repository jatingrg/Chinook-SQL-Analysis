...
/* 2.	Find the top-selling tracks and top artist in the USA and identify their most famous genres. */ -- Count of genres
...
SELECT * FROM topSellingTracknArtist ORDER BY total_sales DESC;
